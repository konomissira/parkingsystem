...
public class DBConstants {
    ...
    //I created this variable to make a discount for regular users
    public static final String GET_TICKET_WITH_OUTTIME = "select t.ID from ticket t where t.VEHICLE_REG_NUMBER=? and t.OUT_TIME IS NOT NULL";
}
